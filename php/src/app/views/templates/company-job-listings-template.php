<?php foreach ($jobs as $job): ?>
    <div class="job-card" data-job-id="<?php echo htmlspecialchars($job['job_vacancy_id']); ?>">
        ...
        <div class="job-info">
            <p><img src="../../../public/images/calendar-icon.svg" alt="Calendar Icon"> <?php echo date('j F Y', strtotime($job['created_at'])); ?></p>
        ...
        <div class="job-widget">
            ...
            <a href="/company-job/<?php echo htmlspecialchars($job['job_vacancy_id']); ?>" class="widget-icon-link">
